...
class PortraitView(context: Context, attrs: AttributeSet?, defStyleAttr: Int) :
    ...
    private fun drawCircleBitmapByXfermode(canvas: Canvas, bitmap: Bitmap) {
        val sc: Int = canvas.saveLayer(0F, 0F, width.toFloat(), height.toFloat(), null, Canvas.ALL_SAVE_FLAG)
        //绘制dst层
